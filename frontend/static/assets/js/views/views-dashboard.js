views_dashboard_display = () => {
  var views_dashboard_page_pretitle = "<p>View</p>";
  var views_dashboard_page_title = "<p>Dashboard</p>";
  var views_dashboard_page_body = `<div class="container-xl">
  ...
  $("#main-content .page-pretitle").empty().html(views_dashboard_page_pretitle);
  $("#main-content .page-title").html(views_dashboard_page_title);
  $("#main-content .page-button").empty();
  $("#main-content .page-body").empty().html(views_dashboard_page_body);
};
